...
from plugp100.components.countdown import Countdown
...
from plugp100.models.firmware import FirmwareDownloadProgress, LatestFirmware
...
class TapoDevice:
    ...
    @property
    def get_device_components(self) -> list[DeviceComponent]:
    ...
    async def update(self):
        ...
        for component in self._active_components.values():
